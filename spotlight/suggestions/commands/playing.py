...
from spotlight.suggestions.items.template_items import FillItem, WarningFillItem
...
class PlayingCommand(Menu):
    def __init__(self, sp: Spotify):
        Menu.__init__(self, "Currently Playing", "Displays the song which is currently playing", "play",
                      "currently playing", [])
        self.sp = sp
